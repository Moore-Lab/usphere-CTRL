...
REGISTERS: list[RegisterDef] = [
    ...
    RegisterDef(" ig Z",                  Category.Z_AXIS, description="Integral gain Z"),
    RegisterDef("fb Z plot",              Category.Z_AXIS, Access.READ, description="Feedback output Z"),
    RegisterDef("dg Z",                   Category.Z_AXIS, description="Derivative gain Z"),
    RegisterDef("dg Z before",            Category.Z_AXIS, description="Derivative gain Z (before chamber)"),
    RegisterDef(" ig Z before",           Category.Z_AXIS, description="Integral gain Z (before chamber)"),
    RegisterDef("pg Z",                   Category.Z_AXIS, description="Proportional gain Z"),
    RegisterDef("pg Z before",            Category.Z_AXIS, description="Proportional gain Z (before chamber)"),
    RegisterDef("pg Z mod",               Category.Z_AXIS, Access.READ, description="Proportional gain Z modulation indicator"),
    ...
    RegisterDef("dgz mod",                Category.Z_AXIS, Access.READ, description="Derivative gain Z modulation indicator"),
    RegisterDef("Reset z accum",          Category.Z_AXIS, is_bool=True, description="Reset Z accumulator"),
    RegisterDef("accum reset z1",         Category.Z_AXIS, Access.READ, is_bool=True, description="Accumulator z1 reset indicator"),
    RegisterDef("accum out z1",           Category.Z_AXIS, Access.READ, description="Accumulator z1 output"),
    RegisterDef("accurm reset z2",        Category.Z_AXIS, Access.READ, is_bool=True, description="Accumulator z2 reset indicator"),
    ...
    RegisterDef("pg Y",                   Category.Y_AXIS, description="Proportional gain Y"),
    ...
    RegisterDef(" ig Y",                  Category.Y_AXIS, description="Integral gain Y"),
    RegisterDef("fb Y plot",              Category.Y_AXIS, Access.READ, description="Feedback output Y"),
    RegisterDef("dg Y",                   Category.Y_AXIS, description="Derivative gain Y"),
    RegisterDef("dg Y before",            Category.Y_AXIS, description="Derivative gain Y (before chamber)"),
    RegisterDef(" ig Y before",           Category.Y_AXIS, description="Integral gain Y (before chamber)"),
    RegisterDef("pg Y before",            Category.Y_AXIS, description="Proportional gain Y (before chamber)"),
    ...
    RegisterDef("dgy mod",                Category.Y_AXIS, Access.READ, description="Derivative gain Y modulation indicator"),
    ...
    RegisterDef(" ig X before",           Category.X_AXIS, description="Integral gain X (before chamber)"),
    RegisterDef("pg X before",            Category.X_AXIS, description="Proportional gain X (before chamber)"),
    ...
    RegisterDef("dgx mod",                Category.X_AXIS, Access.READ, description="Derivative gain X modulation indicator"),
    ...
    RegisterDef("write_address",          Category.ARB_WAVEFORM, Access.WRITE, is_integer=True, description="Waveform write address"),
    RegisterDef("data_buffer_1",          Category.ARB_WAVEFORM, Access.WRITE, is_integer=True, description="Data buffer 1"),
    RegisterDef("data_buffer2",           Category.ARB_WAVEFORM, Access.WRITE, is_integer=True, description="Data buffer 2"),
    RegisterDef("data_buffer3",           Category.ARB_WAVEFORM, Access.WRITE, is_integer=True, description="Data buffer 3"),
    RegisterDef("Arb steps per cycle",    Category.ARB_WAVEFORM, is_integer=True, description="Steps per waveform cycle"),
    RegisterDef("ready_to_write",         Category.ARB_WAVEFORM, Access.WRITE, is_bool=True, description="Host sets True to latch sample into buffer"),
    ...
    # --- COM output ---
    RegisterDef("Trigger for COM out",    Category.COM_OUTPUT, Access.READ, is_bool=True, description="COM output trigger indicator"),
    ...
    RegisterDef("master x",              Category.GLOBAL, Access.READ, is_bool=True, description="Master enable X feedback indicator"),
    RegisterDef("master y",              Category.GLOBAL, Access.READ, is_bool=True, description="Master enable Y feedback indicator"),
