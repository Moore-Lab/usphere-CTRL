...
REGISTERS: list[RegisterDef] = [
    ...
    RegisterDef("pg Z mod",               Category.Z_AXIS, description="Proportional gain Z modulation"),
    ...
    RegisterDef("dgz mod",                Category.Z_AXIS, description="Derivative gain Z modulation"),
    ...
    RegisterDef("data_buffer_1",          Category.ARB_WAVEFORM, is_integer=True, description="Data buffer 1"),
